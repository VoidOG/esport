...
def register(update: Update, context):
    ...
    if TOURNAMENT_MODE == "off":
        ...
        update.message.reply_text(
            "𝗣𝗹𝗲𝗮𝘀𝗲 𝗽𝗿𝗼𝘃𝗶𝗱𝗲 𝘆𝗼𝘂𝗿 𝘁𝗲𝗮𝗺 𝗰𝗿𝗲𝗱𝗲𝗻𝘁𝗶𝗮𝗹𝘀 𝗶𝗻 𝘁𝗵𝗲 𝗳𝗼𝗹𝗹𝗼𝘄𝗶𝗻𝗴 𝗳𝗼𝗿𝗺𝗮𝘁:\n"
            "𝖸𝗈𝗎𝗋 𝖳𝖾𝖺𝗆 𝖭𝖺𝗆𝖾\n"
            "𝖸𝗈𝗎𝗋 𝖴𝖨𝖣 𝗐𝗂𝗍𝗁 𝗒𝗈𝗎𝗋 𝖨𝗇-𝗀𝖺𝗆𝖾 𝖭𝖺𝗆𝖾.\n𝖨𝖿 𝖲𝗊𝗎𝖺𝖽 𝖳𝗈𝗎𝗋𝗇𝖺𝗆𝖾𝗇𝗍 a𝖽𝖽 𝗈𝗍𝗁𝖾𝗋 𝗉𝗅𝖺𝗒𝖾𝗋𝗌 𝖼𝗋𝖾𝖽𝖾𝗇𝗍𝗂𝖺𝗅𝗌 𝗌𝖾𝗉𝖺𝗋𝖺𝗍𝖾𝖽 𝖻𝗒 𝖼𝗈𝗆𝗆𝖺 𝗂𝗇 𝗍𝗁𝖾 𝗌𝖺𝗆𝖾 𝗅𝗂𝗇𝖾.\n\n"
            "𝗘𝘅𝗮𝗺𝗽𝗹𝗲\n\n"
            "𝖳𝖾𝖺𝗆 𝖧𝗈𝗋𝗂𝗓𝗈𝗇\n"
